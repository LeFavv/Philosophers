...
/*   Updated: 2025/09/01 10:10:18 by vafavard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void print_status_if_allowed(t_philo **philo, char *str)
{
    ...
    /* check eating / nb_round_eat safely */
    pthread_mutex_lock(&(*philo)->all->eating_mutex);
    // if (all_ate(*philo) && (*philo)->all->nb_round_eat == (*philo)->all->args.nb_time_eat)
    // {
    //     pthread_mutex_unlock(&(*philo)->all->eating_mutex);
    //     return;
    // }
